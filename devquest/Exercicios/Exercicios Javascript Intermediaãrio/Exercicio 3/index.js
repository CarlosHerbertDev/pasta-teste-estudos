...
let verificarQuadrado = document.querySelector('.quadrado')
verificarQuadrado.addEventListener('click', function() {
    
    if (verificarQuadrado.classList.contains('azul') === true){
        alert('removendo classe')
        verificarQuadrado.classList.remove("azul")
    } else if(verificarQuadrado.classList.contains('azul') === false){
        alert('Não possui essa classe, adicionando')
        verificarQuadrado.classList.add("azul")
    }
})
